    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/feed" className="text-blue-600 hover:underline mt-4 block">
            Go to Feed
          </Link>
        </div>
      </div>
                    ...
                    <tbody className="divide-y">
                      {users.map((u) => (
                        <tr key={u._id} className="hover:bg-gray-50">
                          ...
                          <td className="px-4 py-3">
                            {u.isAdmin && (
                              <span className="px-2 py-1 bg-purple-100 text-purple-700 text-xs rounded-full">Admin</span>
                            )}
                            {u.isSuspended && (
                              <span className="px-2 py-1 bg-red-100 text-red-700 text-xs rounded-full">Suspended</span>
                            )}
                          </td>
            ...
            {activeTab === 'reports' && (
              <div>
                ...
                <div className="space-y-3">
                      ...
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            ...
                            {' '}reported this {report.targetType} for{' '}
                            <span className="font-medium">{report.reason.replace('_', ' ')}</span>
                          </p>
                          {report.description && (
                  ...
                  {reports.length === 0 && (
                    <p className="text-center py-4 text-gray-500 text-sm">No reports found</p>
                  )}
                </div>
              </div>
            )}
