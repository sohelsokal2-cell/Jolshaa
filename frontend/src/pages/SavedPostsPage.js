...
const SavedPostsPage = () => {
  ...
  return (
    <Layout>
      ...
      <h1 className="text-2xl font-bold mb-4 text-on-surface">Saved Posts</h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-on-surface-variant">No saved posts yet</p>
          <p className="text-sm text-on-surface-variant/60 mt-1">Save posts to read them later</p>
        </div>
      ) : (
        <div className="space-y-4">
