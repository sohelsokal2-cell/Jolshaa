    ...
    <div className="relative w-full h-full bg-black flex items-center justify-center">
      ...
      {showComments && (
        <div className="absolute inset-0 z-40 flex flex-col justify-end">
          ...
          <div className="relative bg-white dark:bg-neutral-800 rounded-t-2xl max-h-[60vh] flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-3">
              {comments.length === 0 ? (
                <p className="text-center text-neutral-400 text-sm py-4">No comments yet</p>
              ) : (
                comments.map((c, i) => (
            ...
            <div className="p-3 border-t border-neutral-100 dark:border-neutral-700 flex gap-2">
              <input
                type="text"
                value={commentText}
                ...
                className="flex-1 bg-neutral-100 dark:bg-neutral-700 rounded-full px-4 py-2 text-sm text-neutral-900 dark:text-neutral-100 placeholder-neutral-400 focus:outline-none"
              />
              <button
