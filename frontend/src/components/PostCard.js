  ...
  return (
    <div className="bg-white rounded-lg shadow-md mb-4">
      ...
      {post.media && post.media.length > 0 && (
        <div className={`px-4 pb-2 ${post.media.length === 1 ? '' : 'grid grid-cols-2 gap-1'}`}>
      ...
      <div className="px-4 py-1 flex items-center justify-between border-b">
        ...
        <button className="flex items-center gap-1 px-3 py-1 rounded-full text-sm text-gray-500 hover:bg-gray-100">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
