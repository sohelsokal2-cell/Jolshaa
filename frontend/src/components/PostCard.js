        ...
        <div className="flex items-center justify-between">
          ...
          {post.commentPrivacy === 'none' && !isOwner ? (
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-medium text-neutral-600 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
